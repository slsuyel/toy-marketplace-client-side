    ...
    return (
        <section className="container mt-5">
            <div className="row">
                ...
                <div className="col-lg-6">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT08Sh_TJ45BRDE_HMdluPzwuvCuxeiZqPecQ&usqp=CAU" alt="About Us" className="img-fluid about-image" />
                </div>
            </div>
        </section>
    );
